...
$countPendingUsers = $pendingUsers->num_rows;
      ...
      <div class="content">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Pending Applicants</h5>
                <h3 class="card-title">
                  <i class="tim-icons icon-bell-55 text-primary"></i> <?php echo $countPendingUsers; ?>
                </h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
                  <center><img src="/driving_license/assets/img/process-1.png" alt=""></center>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Active License</h5>
                <h3 class="card-title">
                  <i class="tim-icons icon-check-2 text-success"></i> <?php echo $countActiveLicense; ?>
                </h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
                  <center><img src="/driving_license/assets/img/process-5.png" alt=""></center>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Expired License</h5>
                <h3 class="card-title">
                  <i class="tim-icons icon-simple-remove text-success"></i> <?php echo $countExpiredLicense; ?>
                </h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
