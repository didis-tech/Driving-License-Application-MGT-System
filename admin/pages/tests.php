...
$tests = $conn->query("SELECT * FROM `driving_test`,`user` where driving_test.driver_id=user.user_id");
$counttests = $tests->num_rows;
                                ...
                                <table class="table tablesorter " id="users">
                                    ...
                                    <tbody>
                                        <?php foreach ($tests as $key => $test) { ?>
                                            <tr>
                                                <td> <img src="/driving_license/assets/passports/<?php echo $test['passport']; ?>" alt="" width="20">

                                                </td>
                                                <td><?php echo $test['firstname'] . ' ' . $test['lastname']; ?></td>
                                                <td><?php echo $test['driving_skill']; ?></td>
                                                <td><?php echo $test['sight']; ?></td>
                                                <td><?php echo $test['overtaking']; ?></td>
                                                <td><?php echo $test['braking']; ?></td>
                                                <td><?php echo $test['total']; ?></td>
                                                <td>
                                                    <?php
                                                    if ($test['test_status'] === 'pass') {
                                                        echo "<span class='btn btn-success'>" . $test['test_status'] . "</span>";
                                                    } else {
                                                        echo "<span class='btn btn-danger'>" . $test['test_status'] . "</span>";
                                                    }
