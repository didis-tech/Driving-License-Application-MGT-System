...
if (isset($_POST['new_password'])) {
  ...
  if (password_verify($old_password, $stored_password)) {
    $conn->query("UPDATE admins set adm_password='$hash_password' where adm_id='$id'");
    echo "<script>window.location='./user.php'</script>";
  } else {
    echo "<script>alert('Sorry! - Invalid old password. '); window.location='./user.php'</script>";
  }
}
?>
<!DOCTYPE html>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="First name" value="<?= $adm_firstname ?>">
                      </div>
                    </div>
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        <label>Last Name</label>
                        <input type="text" class="form-control" placeholder="Last Name" value="<?= $adm_lastname ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="email" value="<?= $adm_email ?>">
                      </div>
                    </div>
                    <div class="col-md-6 px-md-1">
                      <div class="form-group">
                        <label>Username</label>
                        <input type="text" class="form-control" placeholder="Username" value="<?= $phone ?>">
                      </div>
                    </div>
                  </div>
                </form>
              ...
              <div class="card-body">
                ...
                <div class="author">
                  ...
                  <a href="javascript:void(0)">
                    ...
                    <h5 class="title"><?php echo $adm_firstname . ' ' . $adm_lastname; ?></h5>
                  </a>
                  <p class="description">
